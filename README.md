...
Given the business problem, I'm analyzing the Industry taking the following steps:

1. **Validate that it's a growing industry:** First, I need to understand whether it makes sense to enter the Film Industry. Therefore, I'm going to analyze the market and see if it shows signs of health. For that, I'm studying whether the No. Released of Movies is growing every year. The Demand and Supply Rule says that supply will follow demand. Therefore, if I confirm that the number of movies is going up every year, most likely, the same is happening with the number of customers/viewers, and, consequently, it's an investable market.
2. **Understand which styles/genres are growing:** The next step is to dig a bit more and analyze the same number by genre. I'm following the same Demand/Supply Rule, trying to find which `genres` are more popular. With that, we can identify opportunities or avoid creating a product that would face a lot of competition.
3. **Understand what customers are telling us:** After looking at the No. of Released movies, it's time to look at the data points that will tell me what customers want. For that, I'm going to analyze which movies have High Ratings and Votes. The No. of Votes tells a different story here. If someone is willing to go to IMDb.com and voting, it's because they hated/loved the movie or love movies in general (that's my hypothesis). Either way, it's a different perspective, and by taking this approach, maybe I can find out what customers are trying to tell. I understand that this approach's problem is that it will ultimately be skewed by the most voted movies out there. Also, IMDb.com represents only a fraction of all customers, maybe not representing the whole population. So any recommendations/conclusions would require more research (just like any conclusions here).
4. **See if specific roles impact No. of Votes:** This might be a long shot since I don't have all the data for all movies because the dataset I'm working with shows only the 'principal' roles. But the idea is to see if certain roles have more power than others in terms of the Number of Votes they bring. With this, Microsoft can dedicate their time/money to roles that matter the most because you cannot have the best on everything in a movie.
5. **Impact of releasing a movie internationally:** Finally, I'm trying to find if there's some correlation between the No. of Votes and No. of Countries/Regions in which the movie was released. With this information, Microsoft knows whether they need to invest money in making the movie famous in other countries or not. Making a movie an international success is expensive (Marketing Materials, hiring other actors to translate the film in different languages, organizing launches in different countries, etc.).
